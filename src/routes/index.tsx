          ...
          <div className="grid md:grid-cols-5 gap-10 md:gap-14">
            <div className="reveal md:col-span-2 space-y-7">
              ...
              <div className="space-y-4">
                ...
                <a href="mailto:cabin237studio@gmail.com" className="flex items-center gap-4 text-burgundy hover:text-amber transition group min-w-0">
                  ...
                  <span className="font-semibold tracking-wide break-all text-sm sm:text-base">cabin237studio@gmail.com</span>
                </a>
